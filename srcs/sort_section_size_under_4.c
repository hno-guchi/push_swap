...
/*   Updated: 2022/12/02 08:48:07 by hnoguchi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_list	*sort_section_size_2(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
	int		i;
...
static t_list	*try_sort_max_mid_min(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
...
static t_list	*try_sort_max_min_mid(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
	log = execute_operation(Push_b, stack_a, stack_b, log);
	log = try_sort(info, stack_a, stack_b, log);
	log = try_sort(info, stack_a, stack_b, log);
...
static t_list	*try_sort_mid_max_min(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
	log = execute_operation(Push_b, stack_a, stack_b, log);
	log = execute_operation(Swap_a, stack_a, stack_b, log);
	log = try_sort(info, stack_a, stack_b, log);
...
static t_list	*try_sort_mid_min_max(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
	log = execute_operation(Swap_a, stack_a, stack_b, log);
	log = try_sort(info, stack_a, stack_b, log);
	log = try_sort(info, stack_a, stack_b, log);
...
static t_list	*try_sort_min_max_mid(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
	log = try_sort(info, stack_a, stack_b, log);
	log = execute_operation(Swap_a, stack_a, stack_b, log);
	log = try_sort(info, stack_a, stack_b, log);
...
static t_list	*try_sort_min_mid_max(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
	int	i;
...
static t_list	*sort_section_size_3(t_sort_info *info, t_dcl_list *stack_a, t_dcl_list *stack_b, t_list *log)
{
	t_order	order;
